...
";
        ...
        if (($this->getAttribute((isset($context["this"]) ? $context["this"] : null), "getDescription", array(), "method") || $this->getAttribute((isset($context["this"]) ? $context["this"] : null), "isInInlineEditorMode", array(), "method"))) {
            // line 6
            echo "<div class=\"category-description\" data-inline-editable ";
...
/* <div class="category-description" data-inline-editable {{ this.printTagAttributes(this.getCategory().getFieldMetadata('description'))|raw }}>{{ this.getDescription()|raw }}</div>*/
/* {% endif %}*/
/* */
